...
export const OdtToPdf: React.FC = () => {
  return (
    <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow">
      <h2 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">ODT to PDF</h2>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Convert OpenDocument Text (ODT) files to PDF.</p>
      ...
      <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        <p className="text-gray-500 mb-2">Upload ODT file</p>
